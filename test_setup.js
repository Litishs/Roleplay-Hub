...
ws.on('open', () => {
  ws.send(JSON.stringify({id:1, method:'Runtime.evaluate', params:{expression:'typeof document.querySelector("#app").__vue_app__._instance.setupState', returnByValue:true}}));
});
ws.on('message', (d) => {
