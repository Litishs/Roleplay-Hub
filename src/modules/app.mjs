...
${content}
        ...
        // Chat generation pipeline lives in useMessageSender (Phase 2.2). Called here
        // because the deps object closes over helpers defined throughout setup();
        // generateResponse is only invoked at runtime (send / regenerate / tool
        // continuation / triggered sends), so the late binding is safe.
