...
export { DEFAULT_PRESET_DEFINITIONS };
globalThis.DEFAULT_PRESET_DEFINITIONS = DEFAULT_PRESET_DEFINITIONS;
if (typeof window !== "undefined") window.DEFAULT_PRESET_DEFINITIONS = DEFAULT_PRESET_DEFINITIONS;
