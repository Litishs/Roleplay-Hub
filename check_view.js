...
ws.on('open', () => {
  ws.send(JSON.stringify({id:1, method:'Runtime.evaluate', params:{expression:'document.querySelector("#app").__vue_app__._instance.proxy.currentView', returnByValue:true}}));
});
ws.on('message', (d) => {
