(() => {
    ...
    /**
     * RPHTts —— TTS 语音引擎桥（P0：Android 系统 TextToSpeech）
     *
     * 浏览器端依赖 Capacitor 原生插件 TTSSpeech（TTSSpeechPlugin.java）；
     * 非 Capacitor 环境（桌面浏览器/Node）graceful 降级，available=false。
     * 状态机：idle -> speaking -> idle；只认当前 utteranceId 的回调，忽略陈旧回调。
     */
