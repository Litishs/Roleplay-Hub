...
ws.on('open', () => {
  ws.send(JSON.stringify({id:1, method:'Runtime.evaluate', params:{expression:'var a=document.querySelector("#app").__vue_app__;typeof a._instance', returnByValue:true}}));
});
ws.on('message', (d) => {
